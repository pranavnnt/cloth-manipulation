...
#include <cloth_manipulation/cartesian_pose_example_controller.h>
    ...
    for (size_t i = 0; i < q_start.size(); i++) {
      if (std::abs(state_handle.getRobotState().q_d[i] - q_start[i]) > 0.1) {
        ROS_ERROR_STREAM(
            ...
            "running this example. Run `roslaunch cloth_manipulation move_to_start.launch "
...
PLUGINLIB_EXPORT_CLASS(cloth_manipulation::CartesianPoseExampleController,
