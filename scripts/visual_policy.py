...
class RealSenseROS:
    ...
    def fixed_policy(self, pose):
        ...
        pose_policy = Pose()
        pose_policy.position.x = pose.position.x
        pose_policy.position.y = pose.position.y
        pose_policy.position.z = 0.25

        pose_policy.orientation.x = 0.0
        pose_policy.orientation.y = 0.0
        pose_policy.orientation.z = 0.0
        pose_policy.orientation.w = 1.0
...
if __name__ == "__main__":
    ...
    while True:    
        ...
        if valid:
            ...
            print("Camera Coordinate: ", world_coordinate)
            ...
            try:
                ...
                pose_policy = rs_ros.fixed_policy(pose_transformed.pose)
                rs_ros.visualize_point(pose_policy)
